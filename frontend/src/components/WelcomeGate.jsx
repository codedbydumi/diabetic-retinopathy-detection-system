    ...
    <div className="welcome-gate">
      <div className="welcome-card">
        ...
        <div className="welcome-disclaimer-box">
          ...
          <p>
            This system is a clinical decision-support tool and is not
            a diagnostic device. All predictions must be reviewed and
            confirmed by a qualified clinician before any clinical
            decision is made.
          </p>
        </div>
